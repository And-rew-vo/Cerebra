...
import com.cerebra.app.ui.main.LibraryViewModel_HiltModules_KeyModule_ProvideFactory;
import com.cerebra.app.ui.main.ProfileViewModel;
import com.cerebra.app.ui.main.ProfileViewModel_HiltModules_KeyModule_ProvideFactory;
import com.cerebra.app.ui.training.TrainingViewModel;
import com.cerebra.app.ui.training.TrainingViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerCerebraApplication_HiltComponents_SingletonC {
  private DaggerCerebraApplication_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public CerebraApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements CerebraApplication_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public CerebraApplication_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl(singletonCImpl);
    }
  }

  private static final class ActivityCBuilder implements CerebraApplication_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public CerebraApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements CerebraApplication_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public CerebraApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements CerebraApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public CerebraApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements CerebraApplication_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public CerebraApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements CerebraApplication_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public CerebraApplication_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements CerebraApplication_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public CerebraApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends CerebraApplication_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends CerebraApplication_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends CerebraApplication_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends CerebraApplication_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends CerebraApplication_HiltComponents.ViewModelC {
    ...
    private Provider<AddTextViewModel> addTextViewModelProvider;
  ...
  private static final class ActivityRetainedCImpl extends CerebraApplication_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends CerebraApplication_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends CerebraApplication_HiltComponents.SingletonC {
    ...
    private Provider<TextRepositoryImpl> textRepositoryImplProvider;

    private Provider<TextRepository> bindTextRepositoryProvider;
    ...
    private TextDao textDao() {
      return DatabaseModule_ProvideTextDaoFactory.provideTextDao(provideAppDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.textRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 0);
      this.bindTextRepositoryProvider = DoubleCheck.provider((Provider) textRepositoryImplProvider);
    ...
    @Override
    public void injectCerebraApplication(CerebraApplication cerebraApplication) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.cerebra.app.data.repository.TextRepositoryImpl 
          return (T) new TextRepositoryImpl(singletonCImpl.textDao());

          case 1: // com.cerebra.app.data.local.AppDatabase 
          return (T) DatabaseModule_ProvideAppDatabaseFactory.provideAppDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 2: // com.cerebra.app.data.repository.UserPreferencesRepository 
